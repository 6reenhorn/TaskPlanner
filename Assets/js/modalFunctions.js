...
document.getElementById('saveTaskBtn').addEventListener('click', function () {
    ...
    taskCard.innerHTML = `
        ...
        <div class="card-body">
            <ul class="card-text mt-0">
                ...
                <li>Priority: <span>${priority.charAt(0).toUpperCase() + priority.slice(1)}</span></li>
            </ul>
    ...
    const deleteButton = taskCard.querySelector('.task-btn-delete');
    ...
    const editButton = taskCard.querySelector('.task-btn-edit');
    editButton.addEventListener('click', () => {
        alert('Edit functionality not implemented yet!');
    });

    const commentButton = taskCard.querySelector('.task-btn-comment');
    commentButton.addEventListener('click', () => {
        alert('Comment functionality not implemented yet!');
    });

    // Append the new task card to the task container
